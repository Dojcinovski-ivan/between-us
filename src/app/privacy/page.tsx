    ...
    <main className={`landing-theme font-karla ${fraunces.variable} ${karla.variable}`}>
      ...
      <article className="mx-auto w-full max-w-[720px] px-6 pb-24 pt-32 sm:pt-40">
        ...
        <Paragraph>
          ...
          Analytics, the Meta Pixel and the X Pixel, to understand how
          people find and use Between Us. You can accept or decline this
          the first time you visit, and you can change your mind at any
          time by clicking Cookie settings in the footer of the site.
        </Paragraph>
        <Paragraph>
          The Meta Pixel and the X Pixel run only on our public pages,
          such as the home page and the blog. Neither is ever active
          inside your circle, your profile, or anywhere else you are
          signed in, so what you read and write inside the community is
          never shared with Meta or X.
        </Paragraph>
        ...
        <Paragraph>
          ...
          emails. Vercel hosts the website. Google Analytics, Meta and X
          help us understand usage and how people find us, only with your
